...
export default class RequestBuilder extends Component {
  ...
  clearQuestionnaireResponses = (e) => {
    console.log(
      "Clear QuestionnaireResponses from the EHR: " +
        this.state.ehrUrl +
        " for author " +
    ...
    client
      .request("QuestionnaireResponse?author=" + this.state.defaultUser, {
        flat: true,
      })
      .then((result) => {
        console.log(result);
        result.forEach((resource) => {
          ...
          client
            ...
            .then((result) => {
              this.consoleLog(
                "Successfully deleted QuestionnaireResponse " +
                  resource.id +
                  " from EHR",
                types.info
              );
            ...
            .catch((e) => {
              console.log(
                "Failed to delete QuestionnaireResponse " + resource.id
              );
              console.log(e);
            });
        });
  ...
  resetPims = (e) => {
    ...
    fetch(resetUrl, {
      ...
      .catch((error) => {
        ...
        this.consoleLog(
          "Server returned error when resetting pims: ",
          types.error
        );
  ...
  resetRemsAdmin = (e) => {
    ...
    fetch(resetUrl, {
      ...
      .catch((error) => {
        ...
        this.consoleLog(
          "Server returned error when resetting rems admin etasu: ",
          types.error
        );
        this.consoleLog(error.message);
        console.log(error);
    ...
    return (
      <div>
        <div className="nav-header">
          <button
            className={
              "launch-button left-button btn btn-class " +
              (this.state.ehrLaunch ? "active" : "not-active")
            }
          ...
          <button
            className={
              "launch-button right-button btn btn-class " +
              (!this.state.ehrLaunch ? "active" : "not-active")
            }
          ...
          <button
            className={
              "btn btn-class settings " +
              (this.state.showSettings ? "active" : "not-active")
            }
            onClick={() =>
        ...
        <div className="form-group container left-form">
          ...
          {this.state.showSettings ? (
            <SettingsBox headers={header} updateCB={this.updateStateElement} />
          ) : null}
          <div>
            {/*for the ehr launch */}
            <RequestBox
