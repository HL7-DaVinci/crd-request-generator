...
export default class RequestBuilder extends Component {
    ...
    submit_info(prefetch, request, patient, extraPrefetch, hook, deidentifyRecords) {
        ...
        let json_request = buildRequest(request, patient, this.state.ehrUrl, this.state.token, prefetch, this.state.prefetch, extraPrefetch, hook, hookConfig, deidentifyRecords);
